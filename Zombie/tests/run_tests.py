...
# 테스트 모듈 import
from tests.test_jobs import TestCivilian, TestPolice, TestDoctor, TestThief
...
def run_all_tests():
    ...
    # 직업 테스트
    suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestCivilian))
    suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestPolice))
    suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestDoctor))
    suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestThief))
